...
- [JYR8010 EFHW antenna results](antenna-results/README.md) - calibrated NanoVNA supported-band SWR, impedance, return-loss, Smith-chart, threshold-bandwidth, interactive, and raw Touchstone results.
