...
- [Peak Design radio standoff](docs/peak-design-radio-standoff.md) - an opposed-face cup-holder adapter for an SDS150 and a universal belt-clip handheld, with coupons and independent load/fit checks.
...
`build_all.py` runs all 28 geometry checks in order and stops at the first
