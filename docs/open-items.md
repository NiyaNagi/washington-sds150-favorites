...
| Anytone DMR rows with no talkgroup | 6 of PSHAM01's coordinated DMR machines without a published layout - WW7STR 146.875, W7BPD 440.375, N7ER 440.700, WA7DMR 440.7125, K7TGU 442.5875, NB7AT 442.850 - are programmed but cannot be keyed. Where the machine is in the DMR network lists, the talkgroup channels transmit; add a talkgroup to the rest only if you want to key them. |
