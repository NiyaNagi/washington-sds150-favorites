...
![TID TD771 Broadband overview](charts/broadband-overview.png)

### Scanner scorecard

![TID TD771 Scanner scorecard](charts/scanner-scorecard.png)

### Authoritative averaged zoom panels

![TID TD771 Authoritative averaged zoom panels](charts/authoritative-zoom-panels.png)

### Impedance and return loss

![TID TD771 Impedance and return loss](charts/impedance-return-loss.png)
