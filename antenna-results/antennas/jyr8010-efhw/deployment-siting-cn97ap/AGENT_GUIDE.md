...
| Feed at the operator's roof dot (49 ft @ 210°M), sloping down or up? | **Down: no** — from 25 ft the wire stays within 7.5° of level, best 34/75. **Up:** slopers a wash (50/75, supports 67–78 ft off the lot); **inverted‑V 54/75 vs 50/75 from the transformer**, 50 ft throw; L 59/75 (unvalidated). Height 25 ft is ASSUMED — the lineup page shows 20/30 ft. |
| Best straight sloper off the roof point (NEC, exhaustive)? | **Toward ~59°M, support ~123–126 ft out at 55–67 ft: 47–49/75, on the lot, clear of the setback**, robust to ±2°/±0.5 m and to roof height 20–30 ft (`tools/nec_roof_sloper_scan.py`). Best anywhere 54/75 lands 81 ft on the neighbour's land. Down-slopers ~level, 35/75. Do not re-scan unless the roof point or height changes. |
