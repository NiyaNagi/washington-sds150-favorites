...
Ten topologies scored against the same 25 regions on 20 m, all sharing the fixed feed
point, with support positions constrained inside the parcel. Generated by
